...
import { DistributedVectorStore } from '../../../../../src/services/features/llm/vector_stores/DistributedVectorStore';
  ...
  describe('getEmbeddingById', () => {
    it('should call getEmbeddingById on the correct sub-store', async () => {
      ...
      const mockEmbedding2 = {
        id: new MediaItemEmbeddingId(mockStore2Id, 'existingId'),
        mediaItemId: { clientId: 'client2', objectId: 'obj2' }
      };
      ...
      stores[1].getEmbeddingById.mockResolvedValue(mockEmbedding2);
