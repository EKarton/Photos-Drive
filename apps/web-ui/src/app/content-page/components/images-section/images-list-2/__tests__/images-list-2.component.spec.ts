...
import { ImagesList2Component } from '../images-list-2.component';
...
describe('ImagesList2Component', () => {
  ...
  it('should render images', () => {
    const fixture = TestBed.createComponent(ImagesList2Component);
