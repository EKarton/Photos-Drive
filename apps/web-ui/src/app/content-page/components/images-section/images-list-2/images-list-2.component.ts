...
@Component({
  standalone: true,
  selector: 'app-content-images-list-2',
  imports: [
    CommonModule,
    NgxMasonryModule,
  ...
  templateUrl: './images-list-2.component.html',
  styleUrl: './images-list-2.component.scss',
})
export class ImagesList2Component implements AfterViewInit, OnDestroy {
