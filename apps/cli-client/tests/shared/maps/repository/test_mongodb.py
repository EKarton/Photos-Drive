...
from photos_drive.shared.metadata.albums.album_id import AlbumId, album_id_to_string
...
from photos_drive.shared.metadata.testing import create_mock_mongo_client
