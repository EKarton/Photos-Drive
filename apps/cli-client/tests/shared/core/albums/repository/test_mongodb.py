...
class TestAlbumsRepositoryImpl(unittest.TestCase):
    ...
    def test_get_album_by_id_wrong_client_id(self):
        with self.assertRaisesRegex(
            ValueError, "Album .* belongs to a different client"
        ):
            self.repo.get_album_by_id(
                AlbumId(ObjectId(), ObjectId("5f50c31e8a7d4b1c9c9b0b1b"))
            )
    ...
    def test_delete_many_albums__with_wrong_client_id__raises_value_error(self):
        existing_album_id = AlbumId(
            MONGO_CLIENT_ID, ObjectId("5f50c31e8a7d4b1c9c9b0b1b")
        )
        wrong_client_album_id = AlbumId(
            ObjectId(), ObjectId("5f50c31e8a7d4b1c9c9b0b1c")
        )
        ...
        with self.assertRaises(ValueError):
            self.repo.delete_many_albums([existing_album_id, wrong_client_album_id])
    ...
    def test_delete_album__with_wrong_client_id(self):
        album_id = AlbumId(ObjectId(), ObjectId("5f50c31e8a7d4b1c9c9b0b1b"))
    ...
    def test_update_album__with_wrong_client_id__throws_error(self):
        album_id = AlbumId(ObjectId(), ObjectId("5f50c31e8a7d4b1c9c9b0b1b"))
        updated_fields = UpdatedAlbumFields(
            new_name="New Name",
            new_parent_album_id=AlbumId(ObjectId(), ObjectId()),
