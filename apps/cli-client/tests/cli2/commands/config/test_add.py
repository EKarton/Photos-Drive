...
class TestAddCli(unittest.TestCase):
    def setUp(self):
        ...
        # Test setup: mock ObjectId
        self.mock_new_object_id = '679be55dcdebca5cfe66741d'
        patch.object(ObjectId, '__init__', return_value=None).start()
        patch.object(ObjectId, '__new__', return_value=self.mock_new_object_id).start()
    ...
    def test_add_gphotos(self):
        ...
        with open(self.temp_file_path, 'r') as f:
            ...
            self.assertEqual(
                ...
                + '[5f50c31e8a7d4b1c9c9b0b1c]\n'
                + 'type = root_album\n'
                + f'client_id = {self.mongodb_client_id}\n'
                + f'object_id = {self.root_album_id.object_id}\n'
                + '\n'
                + f'[{self.mock_new_object_id}]\n'
                + 'type = gphotos_config\n'
                + 'name = bob@gmail.com\n'
                + 'read_write_token = 123\n'
                + 'read_write_refresh_token = 456\n'
                + 'read_write_client_id = clientId1\n'
                + 'read_write_client_secret = clientSecret1\n'
                + 'read_write_token_uri = google.com\n'
                + 'read_only_token = abc\n'
                + 'read_only_refresh_token = def\n'
                + 'read_only_client_id = clientId2\n'
                + 'read_only_client_secret = clientSecret2\n'
                + 'read_only_token_uri = python.com\n'
                + '\n',
            )
    ...
    def test_add_mongodb(self):
        ...
        with open(self.temp_file_path, 'r') as f:
            ...
            self.assertEqual(
                ...
                + 'type = mongodb_config\n'
                + 'name = bob@gmail.com\n'
                + 'read_write_connection_string = mongodb://localhost:8080\n'
                + 'read_only_connection_string = mongodb://localhost:9090\n'
                + '\n',
            )
